...
/* 
   ...
   *종류
   ...
   strncpy(str1,str2,count)  :str2를 str1에 count 개수 만큼 복사

   strcat(str1,str2)         :str2를 str1뒤에 연결
   strncat(str1,str2,count)  :str2를 str1뒤에 count 개수 만큼 연결
